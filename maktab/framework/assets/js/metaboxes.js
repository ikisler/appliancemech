function showHidePostFormatField(){    
    jQuery('#normal-sortables>[id*="ott-format-"]').each(function(){
       if(jQuery(this).attr('id').replace("ott","post")===jQuery('#post-formats-select input:radio:checked').attr('id').replace('image', '0')){
...
jQuery(function(){
    ...
    /* Select options */            
    jQuery(".ott-metaboxes select").each(function(){
        $this = jQuery(this);
    ...
    jQuery("#header_type select").change(function(){
        ...
        if( $this.val() == "subtitle" ){
            jQuery(".ott-metaboxes #subtitle").fadeIn();
            jQuery(".ott-metaboxes #bg_image").fadeIn();
            jQuery(".ott-metaboxes #slider_id").fadeOut();
            jQuery(".ott-metaboxes #googlemap").fadeOut();
        } else if($this.val() == "revolution_slider") {
            jQuery(".ott-metaboxes #slider_id").fadeIn();
            jQuery(".ott-metaboxes #subtitle").fadeOut();
            jQuery(".ott-metaboxes #bg_image").fadeOut();
            jQuery(".ott-metaboxes #googlemap").fadeOut();
    ...
    /* Page layout options */
    jQuery(".ott-metaboxes .type_layout a").each(function(){
        $val = jQuery(".ott-metaboxes .type_layout input").val();
        $this = jQuery(this);
        if( $this.data("value") == $val ){
            $this.addClass("active");
        }
    });
    jQuery(".ott-metaboxes .type_layout a").click(function(){
        jQuery(".ott-metaboxes .type_layout a").removeClass("active");
        $val = jQuery(this).data('value');
        jQuery(".ott-metaboxes .type_layout input").val($val);
