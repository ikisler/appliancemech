<div class="fontawesome-ajax-data">
    <div class="general-field-container">
        ...
        <div class="field-item type-color">
            ...
            <div class="field-data">
                <div class="color-info"></div>
                <input data-name="cc_track_color" data-type="color" class="field" value="#E12E36" placeholder="" type="text"/>
            </div>
            <div class="field-desc"></div>
        </div>
    ...
    <div class="fontawesome-field-container">
        <div class="container">
            ...
            <?php include(THEME_PATH . "/framework/pagebuilder/retina-icon-view.php"); ?>
        </div>
    </div>
</div>