...
class flickrwidget extends WP_Widget {
    ...
    function flickrwidget() {
        ...
        parent::WP_Widget(false, 'OTT flickr', $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p><label for="<?php echo $this->get_field_id('flickr_title'); ?>"><?php _e('Title:', 'otouch'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('flickr_userid'); ?>"><?php _e('Flickr user ID:', 'otouch'); ?></label>
            <br>
        ...
        <p><label for="<?php echo $this->get_field_id('flickr_num'); ?>"><?php _e('How many pictures display:', 'otouch'); ?></label>
