...
class twitterwidget extends WP_Widget {
    function twitterwidget() {
        ...
        parent::WP_Widget(false, 'OTT Twitter', $widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        echo $before_widget;
            ...
            echo do_shortcode('[ott_twitter username="'.$instance['username'].'" tweetstoshow="'.$instance['tweetstoshow'].'" cachetime="'.$instance['cachetime'].'"]');
        echo $after_widget;
    }
}
