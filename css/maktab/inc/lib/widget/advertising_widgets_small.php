...
class ott_Widget_Advertising_125_125 extends WP_Widget {
	
	function ott_Widget_Advertising_125_125() {
		
		$widget_ops = array('classname' => 'widget_advertising_125_125', 'description' => __('Displays your 125 x 125 ads', 'otouch'));
		$this -> WP_Widget('ott-advertising-125-125', __('OTT Advertising 125 x 125', 'otouch'), $widget_ops);
...
function ott_Widget_Advertising_125_125() {
	...
	register_widget('ott_Widget_Advertising_125_125');
	
}

add_action('widgets_init', 'ott_Widget_Advertising_125_125');
