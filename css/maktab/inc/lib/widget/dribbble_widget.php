...
class dribbblewidget extends WP_Widget {
    ...
    function dribbblewidget() {
        ...
        parent::WP_Widget(false, 'OTT dribbble', $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p><label for="<?php echo $this->get_field_id('dribbble_title'); ?>"><?php _e('Title:', 'otouch'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('dribbble_userid'); ?>"><?php _e('dribbble user ID:', 'otouch'); ?></label>
            <br>
        ...
        <p><label for="<?php echo $this->get_field_id('dribbble_num'); ?>"><?php _e('How many dribbble display:', 'otouch'); ?></label>
