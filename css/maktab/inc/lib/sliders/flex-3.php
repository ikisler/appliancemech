...
<section id="slider-home" class="background-flex clearfix">
  <?php
...
?>
  <div class="container">
    <?php if($slides) { ?>
    <div id="inner-slides" class="flexslider style-2 clearfix">
      <ul class="slides">
        <?php
            foreach($slides as $post) : setup_postdata($post);

           $featured_image = wp_get_attachment_image_src(get_post_thumbnail_id(), 'slider_side');
          ...
          <div class="flex-slider-caption-wrap ">
              <div class="flex-slider-caption container">
                <div class="camera_caption_inner">
                  ...
                  <i class="icon-right-dir"></i><span></span></a></div>
                  <?php } ?>
