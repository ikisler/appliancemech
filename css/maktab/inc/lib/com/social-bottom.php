...
<ul class="social_wrapper">
  ...
  <li><a class="ott-rss" title="Rss" href="<?php echo $ot_rss_url; ?>"> <i class="icon-rss"></i> </a></li>
  <?php }?>
  <?php $ot_twitter_username = ott_option('twitter_username'); if(!empty($ot_twitter_username)){?>
  <li><a class="ott-twitter"  title="Twitter" href="http://twitter.com/<?php echo $ot_twitter_username; ?>"> <i class="icon-twitter"></i> </a></li>
  <?php }?>
  <?php $ot_facebook_username = ott_option('facebook_username'); if(!empty($ot_facebook_username)){?>
  <li><a class="ott-facebook" title="Facebook" href="http://facebook.com/<?php echo $ot_facebook_username; ?>"> <i class="icon-facebook"></i> </a></li>
  <?php }?>
  <?php $ot_flickr_username = ott_option('flickr_username'); if(!empty($ot_flickr_username)){ ?>
  <li><a class="ott-flickr" title="Flickr" href="http://flickr.com/people/<?php echo $ot_flickr_username; ?>"> <i class="icon-flickr-1"></i> </a></li>
  <?php }?>
  <?php $ot_youtube_username = ott_option('youtube_username'); if(!empty($ot_youtube_username)){ ?>
  <li><a  class="ott-youtube" title="Youtube" href="http://youtube.com/user/<?php echo $ot_youtube_username; ?>"> <i class="icon-youtube"></i> </a></li>
  <?php }?>
  ...
  <li><a  class="ott-skyoe"  title="skype" href="skype:<?php echo $ot_skype_link; ?>" target="_blank"> <i class="icon-skype-3"></i> </a></li>
  <?php }?>
</ul>
<?php } ?>
