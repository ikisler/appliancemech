...
jQuery(window).load(function() {
    ...
    //Portfolio 
    jQuery('.ott-portfolio').each(function(i){
        ...
        var $currentIsotopeContainer=$currentPortfolio.children('.row').children('.isotope-container');
         // Isotop
        showFilter($currentIsotopeContainer.closest('.row').prev('.ott-filter').children('.filters'),$currentIsotopeContainer.children('article'));
        $currentIsotopeContainer.isotope({
            itemSelector: 'article.ott_portfolio',
        ...
        $currentPortfolio.find('ul.filters').each(function() {
            ...
            $optionLinks.click(function() {
                var $container2 = jQuery(this).closest('.ott-portfolio').find('.isotope-container');
            ...
            if($currentInfinite.attr('data-has-next')==='true'&&$currentNextLink.hasClass('next')){
                ...
                jQuery.ajax({
                    ...
                    success: function(response){
                        var $newElements = jQuery(response).find('.ott-portfolio').eq(i).children('.row').children('.isotope-container').html();
                        var $newURL      = jQuery(response).find('.ott-portfolio').eq(i).find('.ott-infinite-scroll>a.next').attr('href');
                        var $hasNext     = jQuery(response).find('.ott-portfolio').eq(i).find('.ott-infinite-scroll').attr('data-has-next');
                        if($newElements){
